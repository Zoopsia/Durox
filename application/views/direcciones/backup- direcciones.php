		  			...
		  			<div class="panel-body"> 
		  					<form action="<?php echo base_url()."index.php/direcciones/nuevaDireccion/$id/$tipo"?>" class="form-horizontal" method="post">
								...
								<div class="form-group">
									<label class="col-sm-1 col-sm-offset-1 control-label">Tipo</label>
									  	<div class="col-md-3">
											<select id="paises" name="id_pais" class="form-control" data-placeholder="Selecciona una opción...">	
												<?php
								...
								<div class="form-group">
									<label class="col-sm-1 col-sm-offset-1 control-label">Tipo</label>
									  	<div class="col-md-3">
											<select id="provincias" name="id_pais" class="form-control" data-placeholder="Selecciona una opción...">
